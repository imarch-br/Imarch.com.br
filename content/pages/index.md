...
sections:
  - type: GenericSection
    title:
      text: Arquitetura dinâmica de impacto
      color: text-dark
      type: TitleBlock
    ...
    media:
      ...
      type: ImageBlock
    badge:
      label: "Focado na percepção\_ sensorial"
      color: text-primary
      type: Badge
    elementId: ''
  ...
  - type: FeaturedItemsSection
    title:
      text: Materializamos subjetividades
      color: text-dark
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Tudo que só deve ser sentido e não dito em números ou com a razão
    items:
      - type: FeaturedItem
        title: 500k
    ...
    styles:
      ...
      subtitle:
        textAlign: center
  - subtitle: Adjetivos que refletem o a linguagem dos nossos projetos.
    images:
